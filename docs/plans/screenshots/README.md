...
# 产物先落到 mobile/composeApp/build/screenshots/，再复制到这里并改成概念图屏幕名
```
...
| 文件 | 帧尺寸 | 说明 |
| --- | --- | --- |
| `dashboard.png` / `monitor.png` / `standby.png` / `device-setup.png` / `personalization.png` | 1280×720 | 墙面屏形态（2560×1440 @320dpi 的 dp 尺寸） |
